...
\begin{itemize}
    \item Week 7: Implement centralized GAN and federated GAN architectures
    \item Week 8: Train centralized GAN and federated GAN on HAM10000 dataset
    \item Week 9: Evaluate generative quality and privacy leakage
    \item Week 10: Write and finalize documentation and report
\end{itemize}
